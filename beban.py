...
def menu(id):
	...
	print('---> 2. Check Hasil ')
	print('---> 3. Keluar ')
	_____febryven__greyno_____ = input('\n---> Pilih : ')
	if _____febryven__greyno_____ in ['1']:
		nge_krek1()
	elif _____febryven__greyno_____ in ['2']:
		result()
	elif _____febryven__greyno_____ in ['3']:
...
def passwrd():
	...
	print(f'---> Donate : 081388341152 Jangan Pelit Abang Sultan')
