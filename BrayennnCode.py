...
for t in range(10000):
	...
	brayen2=f'Mozilla/5.0 (Linux; Android {a}; SM-N9700 Build/SP1A.{b}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36 HeyTapBrowser/40.8.8.9'
